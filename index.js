...
app.use(cors({ origin: ['http://localhost:3000', 'https://new-era-glazing-solution-uze8.onrender.com', 'https://neweraglazingsolutionsltd.co.uk'], default: 'https://neweraglazingsolutionsltd.co.uk' }));
